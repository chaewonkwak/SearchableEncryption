...
public:
    ...
    static prf_type convertToArray(std::string value);
    static int getMem();
    static double getTimeFromHist(int id);
    static int getBid(std::string srchIndex);
    static prf_type encode(std::string keyword);
    static prf_type encode(std::string keyword, unsigned char* curkey);
    static prf_type encode(unsigned char* plaintext, unsigned char* curkey = NULL);
    static std::string decode(prf_type data, unsigned char* curkey = NULL);
    ...
    static void decode(prf_type ciphertext, prf_type& plaintext, unsigned char* curkey = NULL);

    virtual ~Utilities();
};


#endif //SDD_UTILITIES_H
